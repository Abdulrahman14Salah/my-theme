<section class="relative">
    <div class="relative py-24 lg:py-28">
        <div class="mx-auto px-6 max-w-7xl md:px-12">
            <div class="text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5">
                ...
                <a href="<?php echo esc_url($category_link); ?>" title="WordPress" class="annonce variant-outlined gap-2 sz-sm w-fit mx-auto group">
                    <span class="annonce-concern sz-xs variant-primary">New</span>
                    <span class="text-sm flex gap-6 text-white"> Introducing WordPress!
                        <div class="flex items-center -space-x-3 group-hover:-translate-x-1 transition-transform duration-300">
                            <span class="w-2.5 translate-y-[-0.3px] -translate-x-px opacity-0 h-[1.5px] rounded bg-white origin-left scale-x-0 transition duration-300 group-hover:opacity-100 group-hover:scale-x-100"></span>
                            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" class="size-4 text-white -translate-x-2 transition duration-300 group-hover:translate-x-px" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </div>
                    </span>
                </a>
                <h1 class="mt-8 text-wrap text-4xl md:text-5xl font-semibold xl:text-5xl xl:[line-height:1.125] text-white">Welcome to my website! <br> a professional Web developer</h1>
                <p class="text-wrap mx-auto mt-8 max-w-2xl text-lg text-gray-1050">I'm a WordPress Developer experinced in building websites for all types of companies, organizations and public figures</p>
                <div class="mt-8 flex flex-col items-center justify-center gap-4">
                    <div class="">
                        <a href="<?php echo get_permalink(13); ?>" class="btn variant-primary sz-lg">
                            ...
                            <span class="text-nowrap btn-label">Start Building Website</span>
                        </a>
    ...
    <div class="absolute inset-0 -top-8 left-1/2 -z-20 h-56 w-full -translate-x-1/2 opacity-10 [background-image:linear-gradient(to_bottom,transparent_98%,theme(colors.gray.200/75%)_98%),linear-gradient(to_right,transparent_94%,_theme(colors.gray.200/75%)_94%)] [background-size:16px_35px] [mask:radial-gradient(black,transparent_95%)]"></div>
    <div class="absolute top-12 inset-x-0 w-2/3 h-1/3 -z-[1] rounded-full bg-primary-300 bg-white/20 mx-auto blur-3xl"></div>
</section>